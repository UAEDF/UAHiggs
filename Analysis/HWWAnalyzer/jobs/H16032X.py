...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/data/H1603X_10events.root')
)
...
process.myanalysis = cms.EDAnalyzer("HWWAnalyzer",
    ...
    HistOutFile = cms.untracked.string('outH16022X.root'),
...
#    EndCapClusters = cms.InputTag("islandBasicClusters:islandEndcapShapeAssoc"),
    ...
    requested_hlt_bits = cms.vstring('HLT_IsoEle15_L1I','HLT_IsoEle18_L1R','HLT_IsoEle15_LW_L1I','HLT_LooseIsoEle15_LW_L1R','HLT_Ele10_SW_L1R','HLT_Ele15_SW_L1R','HLT_Ele15_LW_L1R','HLT_IsoMu9', 'HLT_IsoMu11','HLT_IsoMu13', 'HLT_IsoMu15','HLT_Mu3','HLT_Mu5','HLT_Mu7','HLT_Mu9','HLT_Mu11','HLT_Mu13','HLT_Mu15' , 'HLT_Ele10_LW_EleId_L1R'),
