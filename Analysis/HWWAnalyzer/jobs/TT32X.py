...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:///user/xjanssen/HWW/CMSSW_3_2_6/src/Analysis/HWWAnalyzer/jobs/TT3XDataSet_100events.root')
)
...
process.myanalysis = cms.EDAnalyzer("HWWAnalyzer",
    ...
    HistOutFile = cms.untracked.string('TT32X.root'),
