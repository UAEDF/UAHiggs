...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/home/michele/TT22X.root')
)
...
process.myanalysis = cms.EDAnalyzer("HWWAnalyzer",
    ...
    HistOutFile = cms.untracked.string('outTT21X_pdf.root'),
...
#process.p = cms.Path(process.higgsToWW2LeptonsPreselectionSequence*process.multi5x5BasicClusters*process.hybridClusteringSequence*process.jetvertexalpha*process.myanalysis)

process.p = cms.Path(process.higgsToWW2LeptonsPreselectionSequence*process.jetvertexalpha*process.eleIsoFromDepsEcalFromHits*process.electronTrackIsolationLcone*process.myanalysis)
