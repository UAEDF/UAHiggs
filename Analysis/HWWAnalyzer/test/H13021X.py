...
process.myanalysis = cms.EDAnalyzer("HWWAnalyzer",
    ...
    HistOutFile = cms.untracked.string('outH13021X.root'),
...
process.kf130 = mykf.KFactorProducer.clone(
    inputFilename = cms.untracked.string('HiggsAnalysis/HiggsToWW2Leptons/data/130_10TeV.dat'),
    Debug =cms.untracked.bool(False)
)    
process.p = cms.Path(process.kf130*process.higgsToWW2LeptonsPreselectionSequence*process.jetvertexalpha*process.eleIsoFromDepsEcalFromHits*process.myanalysis)
