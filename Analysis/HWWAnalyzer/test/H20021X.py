...
process.myanalysis = cms.EDAnalyzer("HWWAnalyzer",
    ...
    HistOutFile = cms.untracked.string('outH20021X.root'),
...
process.kf200 = mykf.KFactorProducer.clone(
    inputFilename = cms.untracked.string('HiggsAnalysis/HiggsToWW2Leptons/data/200_10TeV.dat'),
    Debug =cms.untracked.bool(False)
)    
process.p = cms.Path(process.kf200*process.higgsToWW2LeptonsPreselectionSequence*process.jetvertexalpha*process.eleIsoFromDepsEcalFromHits*process.myanalysis)
