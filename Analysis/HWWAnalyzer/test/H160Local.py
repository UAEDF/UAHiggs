...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/data/Ezio/TT22X.root')
)
...
process.myanalysis = cms.EDAnalyzer("HWWAnalyzer",
    ...
    HistOutFile = cms.untracked.string('outTT22X.root'),
...
process.p = cms.Path(process.higgsToWW2LeptonsPreselectionSequence*process.jetvertexalpha*process.eleIsoFromDepsEcalFromHits*process.myanalysis)
