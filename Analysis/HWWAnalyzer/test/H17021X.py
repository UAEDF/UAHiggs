...
process.myanalysis = cms.EDAnalyzer("HWWAnalyzer",
    ...
    HistOutFile = cms.untracked.string('outH17021X.root'),
...
process.kf170 = mykf.KFactorProducer.clone(
    inputFilename = cms.untracked.string('HiggsAnalysis/HiggsToWW2Leptons/data/170_10TeV.dat'),
    Debug =cms.untracked.bool(False)
)    
process.p = cms.Path(process.kf170*process.higgsToWW2LeptonsPreselectionSequence*process.jetvertexalpha*process.eleIsoFromDepsEcalFromHits*process.myanalysis)
