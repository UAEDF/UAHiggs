...
process.myanalysis = cms.EDAnalyzer("HWWAnalyzer",
    ...
    HistOutFile = cms.untracked.string('outH50022X.root'),
...
process.kf500 = mykf.KFactorProducer.clone(
    inputFilename = cms.untracked.string('HiggsAnalysis/HiggsToWW2Leptons/data/500_10TeV.dat'),
    Debug =cms.untracked.bool(False)
)    
process.p = cms.Path(process.kf500*process.higgsToWW2LeptonsPreselectionSequence*process.jetvertexalpha*process.eleIsoFromDepsEcalFromHits*process.myanalysis)
