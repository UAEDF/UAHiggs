...
// Class:      HWWGenPart
// 
/**\class HWWGenPart HWWGenPart.cc Analysis/HWWGenPart/src/HWWGenPart.cc
...
//
HWWGenPart::HWWGenPart(const edm::ParameterSet& iConfig)
...
void
HWWGenPart::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
