...
// HWWGenPart Analysis class declaration
#include "Analysis/HWWGenPart/interface/HWWGenPart.h"

bool GenPartDebug = false ;

void HWWGenPart::GetGenPart(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace std;
   using namespace edm;
   ...
   if (!genParticles.isValid()) {
     cerr << "[HWWGenPart::GetGenPart] Error: non valid GenParticleCollection " << endl;
     return;
   }
